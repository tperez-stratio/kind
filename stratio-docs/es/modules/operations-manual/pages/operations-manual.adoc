...
NOTE: Si se usa el _flag_ `--skip-k8s-intermediate-version`, Kubernetes se actualiza directamente de la versión 1.26.X a 1.28.X en un solo paso. Esto solo es compatible con entornos EKS.
