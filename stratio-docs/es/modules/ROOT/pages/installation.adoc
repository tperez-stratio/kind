...
Las imágenes utilizadas deberán estar soportadas por EKS ver link://repost.aws/knowledge-center/eks-custom-linux-ami/[creación de AMI personalizadas].
