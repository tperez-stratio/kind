...
Las imágenes utilizadas deberán estar soportadas por EKS. Consulta la https://repost.aws/knowledge-center/eks-custom-linux-ami/[creación de AMI personalizada para EKS] ^[English]^.
