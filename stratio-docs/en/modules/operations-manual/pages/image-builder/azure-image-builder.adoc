...
To build an Azure image, you need to create a single configuration JSON file for Packer. This file contains the configuration parameters for image generation (image configuration, instance type, region, Kubernetes version, etc.).
