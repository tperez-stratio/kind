...
hose {
    ...
    DEPLOYONPRS = true
    GRYPE_TEST = true
    MODULE_LIST = [ "paas.cloud-provisioner:cloud-provisioner:tar.gz","paas.cloud-provisioner:upgrade-provisioner:tar.gz", "paas.cloud-provisioner:keoscluster_v1beta1_template:yaml" ]
