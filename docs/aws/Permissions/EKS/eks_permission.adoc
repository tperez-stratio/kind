...
| ec2:ModifyNetworkInterfaceAttribute | Attempting to modify network interface attribute | Grants permission to modify a network interface attribute. |  arn:aws:ec2:eu-west-1:<account-id>:network-interface/* | cloud-provisioner
|===
